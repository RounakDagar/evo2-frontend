...
export default function KnownVariants({
  ...
  showComparision: (variant: ClinvarVariant) => void;
  ...
  const analyzeVariant = async (variant: ClinvarVariant) => {
    ...
    try {
      ...
      showComparision(updatedVariant);
    } catch (error) {
      updateClinvarVariant(variant.clinvar_id, {
        ...variant,
        isAnalyzing: false,
      ...
      <CardContent className="pb-4">
        ...
        {isLoadingClinvar ? (
            ...
            <Table>
              <TableHeader className="sticky top-0 z-10">
                <TableRow className="bg-[#e9eeea]/80 hover:bg-[#e9eeea]/30">
                  <TableHead className="py-2 text-xs font-medium text-[#3c4f3d]/70">
                    Variant
                  </TableHead>
                  ...
                  <TableHead className="py-2 text-center text-xs font-medium text-[#3c4f3d]/70">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                ...
                {clinvarVariants.map((variant) => (
                  ...
                  >
                    <TableCell className="py-2">
                      ...
                      <div className="mt-1 flex items-center gap-2 text-xs text-[#3c4f3d]/70">
                        ...
                        {variant.variation_type
                          ...
                          !variant.evo2Result ? (
                            ...
                            <Button
                              ...
                              onClick={() => showComparision(variant)}
                            >
          ...
          <div className="flex h-48 flex-col items-center justify-center text-center text-gray-400">
            ...
            <p>No ClinVar variants found for this gene.</p>
          </div>
        )}
      </CardContent>
    </Card>
